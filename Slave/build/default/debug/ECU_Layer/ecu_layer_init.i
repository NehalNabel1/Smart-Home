...
dc_motor_t dc_motor1= {
  ...
  .dc_motor_pin[0].direction=0x00U,
  .dc_motor_pin[1].pin= PIN1,
  .dc_motor_pin[1].port=PORC_INDEX,
  .dc_motor_pin[1].direction=0x00U
 };
...
void timer3_timer_init(void){
    ...
    timer_obj.TMR3_InterruptHandler=((void*)0);
    ...
    timer_obj.timer3_reg_rw_mode=0;
...
void CCP_SET_Duty(void){
    ...
    ccp1_obj.ccp_variant= ((uint8)0x08) ;
