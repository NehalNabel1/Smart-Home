...
/*This routine set the edge detect of the external interrupt to negative edge*/
#define EXT_INT0_RisingEdgeSet()              (INTCON2bits.INTEDG0=1)
/*This routine set the edge detect of the external interrupt to positive edge*/
